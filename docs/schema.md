...
| `resolved_supplier_golden` | One supplier entity — 5,967 resolved + 7,396 unresolved buckets |
...
| Table | Grain | Rows |
|---|---|---:|
| `dim_supplier` | One supplier entity, **including the unresolved bucket** | 13,363 |
| `dim_entity` | One publishing body | 6 |
| `dim_date` | One day | 728 |
| `dim_category` | One (`entity`, `expense_type_raw`) pair + `uncategorised` | 1,637 |
| `fact_spend` | One payment line to a **resolved** supplier | 175,470 |
| `fact_spend_unresolved` | One payment line, supplier **not** resolved | 177,058 |
