...
| 4 — fuzzy, **review only, not resolved** | 1,199 | 41,348 | 3,244,886,577.86 | 6.32% |
| 5 — unresolved | 6,197 | 135,710 | 18,149,672,696.38 | 35.36% |
...
|---|---:|---:|
| `no_match` — no candidate at any tier | 3,025 | 11,955,540,221.19 |
| `below_threshold` — best fuzzy score under 0.85 | 3,017 | 5,406,615,319.32 |
| `review` — tier-4 queue, decision pending | 1,199 | 3,244,886,577.86 |
| `ambiguous` — more than one candidate, or the register disagrees | 151 | 674,251,129.12 |
...
**1,404 rows, decisions blank, highest value first**: 1,199 tier-4 candidates and the 205
...
it arrived by demotion rather than by similarity. Generated by
`sql/30_resolved/37_build_review_queue.sql`.
